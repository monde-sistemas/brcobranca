...
RSpec.describe Brcobranca::Boleto::Ailos do #:nodoc:[all]
  before do
    @valid_attributes = {
      valor: 0.0,
      local_pagamento: 'PAGÁVEL PREFERENCIALMENTE NAS COOPERATIVAS DO SISTEMA AILOS',
  ...
  it 'Criar nova instancia com atributos padrões' do
    ...
    expect(boleto_novo.local_pagamento).to eql('PAGÁVEL PREFERENCIALMENTE NAS COOPERATIVAS DO SISTEMA AILOS')
