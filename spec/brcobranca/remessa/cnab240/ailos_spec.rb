  ...
  context 'validacoes' do
    ...
    context '@convenio' do
      ...
      it 'deve ser invalido se o convenio tiver mais de 6 digitos' do
        ...
        expect(ailos.invalid?).to be true
        expect(ailos.errors.full_messages).to include('Convenio é muito longo (máximo: 6 caracteres).')
      end
    end
    ...
    context '@conta_corrente' do
      ...
      it 'deve ser invalido se o conta corrente tiver mais de 7 digitos' do
        ...
        expect(ailos.invalid?).to be true
        expect(ailos.errors.full_messages).to include('Conta corrente é muito longo (máximo: 7 caracteres).')
      end
    end
  end
  ...
  context 'montar lote' do
    context 'segmento P' do
      ...
      it 'pagamento com desconto sem data de desconto' do
        pagamento.cod_desconto = '1'
        expect { ailos.monta_lote(1) }.to raise_error(Brcobranca::RemessaInvalida)
      end
    end
