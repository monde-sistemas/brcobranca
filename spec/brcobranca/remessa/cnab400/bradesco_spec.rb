  ...
  context 'monta remessa' do
    ...
    context 'detalhe' do
      it 'informacoes devem estar posicionadas corretamente no detalhe' do
        ...
        expect(detalhe[147..148]).to eq '10' # Espécie do título
      ...
      it 'espécie do título CS converte para código correspondente' do
        pagamento.especie_titulo = 'CS'
        detalhe = bradesco.monta_detalhe(pagamento, 1)
        expect(detalhe[147..148]).to eq '04'
      end
